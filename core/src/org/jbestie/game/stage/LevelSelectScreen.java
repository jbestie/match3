...
public class LevelSelectScreen implements Screen {
    ...
    public LevelSelectScreen(final Match3 game) {
        ...
        stage = new Stage( new FitViewport(GameConstants.WORLD_WIDTH, GameConstants.WORLD_HEIGHT, camera), game.batch); //Set up a stage for the ui
        ...
        for (int i = 0; i < LEVELS_COUNT; i++) {
            ...
            final Button btn = new Button(new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.local("sprites/level_"+ (i + 1)+ ".png")))));
